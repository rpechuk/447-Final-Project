...
class SlangGenModel:
    ...
    def train_categorization(self, slang_ind, fold_name='default', params=None):
        ...
        vocab_embeds = self.load_exemplar_embeddings(fold_name=fold_name, def_embeds=def_embeds, params=params)
    ...
    def load_exemplar_embeddings(self, fold_name='default', def_embeds=None, params=None):
    ...
    def predict(self, slang_def_embeds, labels, fold_name='default', mode='test', params=None):
        ...
        vocab_embeds = self.load_exemplar_embeddings(fold_name=fold_name, params=params)
        categorizer = Categorizer(self.vocab, vocab_embeds, self.cf_feats)
